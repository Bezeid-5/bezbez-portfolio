...
export function MoonIcon(props: IconProps) {
  return (
    <BaseIcon {...props}>
      <path d="M20 15.2A8.5 8.5 0 0 1 8.8 4 8.5 8.5 0 1 0 20 15.2Z" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.6" />
    </BaseIcon>
  );
}
...
export function SunIcon(props: IconProps) {
  return (
    <BaseIcon {...props}>
      ...
      <path d="M12 2.5v2M12 19.5v2M21.5 12h-2M4.5 12h-2M18.7 5.3l-1.4 1.4M6.7 17.3l-1.4 1.4M18.7 18.7l-1.4-1.4M6.7 6.7 5.3 5.3" stroke="currentColor" strokeLinecap="round" strokeWidth="1.6" />
    </BaseIcon>
  );
}
